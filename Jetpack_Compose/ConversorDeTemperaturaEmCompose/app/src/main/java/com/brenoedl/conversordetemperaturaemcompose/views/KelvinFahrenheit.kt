...
@Composable
fun KelvinFahrenheit(backStack: SnapshotStateList<View>) {
    var kelvinString by remember { mutableStateOf("") }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = stringResource(id = R.string.button__kelvin_ceusus),
                        color = White,
        ...
        Column(
            ...
            OutlinedTextFieldCustom(
                ...
                label = { Text(text = stringResource(id = R.string.label_temperatura_kelvin)) },
            ...
            ButtonCustom(
                onClick = {
                    if (kelvinString.isEmpty()) {
                        ...
                        isVasiu = false
                        kelvin = kelvinString.toDouble()
                        fahrenheit = (kelvin - 273.15) * 9 / 5 + 32
                        keyboardController?.hide()
                        formula = "(${String.format("%.2f",  kelvin)}K - 273.15) * 9 / 5 + 32 = ${String.format("%.2f", fahrenheit)}°F"
                    }
                },
