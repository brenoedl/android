...
@Composable
fun CeusiusKelvin(backStack: SnapshotStateList<View>) {
    var celsiusString by remember { mutableStateOf("") }
    var kelvin by remember { mutableDoubleStateOf(0.0) }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(text = stringResource(id = R.string.button__ceusus_kelvin), color = White, fontWeight = FontWeight.Bold)
                },
        ...
        Column(
            ...
            OutlinedTextFieldCustom(
                ...
                label = { Text(text = stringResource(id = R.string.label_temperatura_ceusus)) },
            ...
            ButtonCustom(
                onClick = {
                    if (celsiusString.isEmpty()){
                        ...
                        isVasiu = false
                        celsius = celsiusString.toDouble()
                        kelvin = celsius + 273.15
                        formula = "${String.format("%.2f",  celsius)}°C + 273.15 = ${String.format("%.2f",  kelvin)}K"
