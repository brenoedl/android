...
@Composable
fun FahrenheitKelvin(backStack: SnapshotStateList<View>) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = stringResource(id = R.string.button__fahrenheit_kelvin),
                        color = White,
            ...
            ButtonCustom(
                onClick = {
                    if (fahrenheitString.isEmpty()) {
                        ...
                        formula = "(${String.format("%.2f",  fahrenheit)}°F - 32) * 5 / 9 + 273.15 = ${String.format("%.2f",  kelvin)}K"
                    }
                },
