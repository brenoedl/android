...
@Composable
fun AtualizarContato(navController: NavController, id: String, nome: String, sobrenome: String, idade: String, celular: String) {
    var nome by remember { mutableStateOf(nome) }
    var sobrenome by remember { mutableStateOf(sobrenome) }
    var idade by remember { mutableStateOf(idade) }
                ...
                onClick = {
                    scope.launch(Dispatchers.IO){
                        if (nome.isNotEmpty() && sobrenome.isNotEmpty() && idade.isNotEmpty() && celular.isNotEmpty()){
                            ...
                            contatosDao.atualizarContatos(id.toInt(), nome, sobrenome, idade, celular)
                        }else {
                            mensagem = false
                        }
                    }
